DROP MATERIALIZED VIEW IF EXISTS viz.hex_{region}_{year}_{resolution}m; 
CREATE MATERIALIZED VIEW viz.hex_{region}_{year}_{resolution}m AS 
SELECT 
...
ALTER TABLE viz.hex_{region}_{year}_{resolution}m 
  OWNER TO postgres;
GRANT SELECT ON TABLE viz.hex_{region}_{year}_{resolution}m TO public;
GRANT ALL ON TABLE viz.hex_{region}_{year}_{resolution}m TO postgres;
